...
parser = argparse.ArgumentParser(description="Columbia F1 for CaMIB scores")
parser.add_argument("--pyworkPath", type=str, default=None)
parser.add_argument("--pyframesPath", type=str, default=None)
parser.add_argument("--colSavePath", type=str, default=None)
args = parser.parse_args()

pyworkPath   = args.pyworkPath or col_pywork("pywork_camib")
