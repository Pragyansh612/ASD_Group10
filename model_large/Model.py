...
from model_large.Classifier import Fusion, Detector
from model_large.Encoder import visual_encoder, audio_encoder
...
class ASD_Model(nn.Module):
    def __init__(self):
        ...
        self.detector = Detector(512)
        self.proj = __import__('torch').nn.Linear(256, 128)
