...
from dataLoader_ablation2 import train_loader
from dataLoader import val_loader
from utils.tools import *
from ASD_scer import ASD
...
def main():
    ...
    parser.add_argument('--savePath',     type=str, default="exps/scer")
    # Data selection
    parser.add_argument('--lambda_scer', type=float, default=1.0 if 'scer'=='irm' else 0.1)
