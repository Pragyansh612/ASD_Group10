...
def main():
    ...
    parser.add_argument('--savePath',     type=str, default="exps/irm")
    # Data selection
    parser.add_argument('--lambda_irm', type=float, default=1.0 if 'irm'=='irm' else 0.1)
